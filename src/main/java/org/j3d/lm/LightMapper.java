...
public class LightMapper {
    ...
    public boolean map(File file, Vector<Light> lights, int width, int height, float ambientFactor, Vector<Model> models) throws Exception {
        int px = 0;
        int py = 0;
        int mh = 0;
        int w = 0;
        ...
        for(Model model : models) {
            for(MeshPart part : model.mesh) {
                for(int i = 0; i != part.getFaceCount(); i++) {
                    ...
                    transformed.set(x1, y1, z1).mulPosition(model.model);
                    x1 = transformed.x;
                    y1 = transformed.y;
                    z1 = transformed.z;
                    transformed.set(x2, y2, z2).mulPosition(model.model);
                    x2 = transformed.x;
                    y2 = transformed.y;
                    z2 = transformed.z;
                    transformed.set(x3, y3, z3).mulPosition(model.model);
                    x3 = transformed.x;
                    y3 = transformed.y;
                    z3 = transformed.z;
                    ...
                    if(four) {
                        ...
                        for(int j = 0; j != part.getFaceVertexCount(i); j++) {
                            ...
                            transformed.set(x, y, z).mulPosition(model.model);
                            x = transformed.x;
                            y = transformed.y;
                            z = transformed.z;
        ...
        for(Model model : models) {
            for(MeshPart part : model.mesh) {
                for(int i = 0; i != part.getTriangleCount(); i++) {
                    ...
                    triangle.transform(model.model);
                            ...
                            for(Model model2 : models) {
                                for(MeshPart p : model2.mesh) {
                                    for(int k = 0; k != p.getFaceCount(); k++) {
                                        ...
                                        transformed.set(kx1, ky1, kz1).mulPosition(model.model);
                                        kx1 = transformed.x;
                                        ky1 = transformed.y;
                                        kz1 = transformed.z;
                                        transformed.set(kx2, ky2, kz2).mulPosition(model.model);
                                        kx2 = transformed.x;
                                        ky2 = transformed.y;
                                        kz2 = transformed.z;
                                        transformed.set(kx3, ky3, kz3).mulPosition(model.model);
                                        kx3 = transformed.x;
                                        ky3 = transformed.y;
                                        kz3 = transformed.z;
                                        ...
                                        for(int m = 0; m != p.getFaceVertexCount(k); m++) {
                                            ...
                                            transformed.set(mx1, my1, mz1).mulPosition(model.model);
                                            mx1 = transformed.x;
                                            my1 = transformed.y;
                                            mz1 = transformed.z;
                                            transformed.set(mx2, my2, mz2).mulPosition(model.model);
                                            mx2 = transformed.x;
                                            my2 = transformed.y;
                                            mz2 = transformed.z;
